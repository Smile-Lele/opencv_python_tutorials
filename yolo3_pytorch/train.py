...
if __name__ == "__main__":
    ...
    if True:
        ...
        gen = DataLoader(train_dataset, shuffle=True, batch_size=Batch_size, num_workers=3, pin_memory=True,
                         drop_last=True, collate_fn=yolo_dataset_collate)
        gen_val = DataLoader(val_dataset, shuffle=True, batch_size=Batch_size, num_workers=3, pin_memory=True,
                             drop_last=True, collate_fn=yolo_dataset_collate)
